...
exports.insertOrAppend = exports.getInsertOrAppendInstructionDataSerializer = void 0;
const umi_1 = require("@metaplex-foundation/umi");
const serializers_1 = require("@metaplex-foundation/umi/serializers");
const shared_1 = require("../shared");
function getInsertOrAppendInstructionDataSerializer() {
    ...
    ], { description: 'InsertOrAppendInstructionData' }), (value) => ({
        ...value,
        discriminator: [6, 42, 50, 190, 51, 109, 178, 168],
    }));
}
exports.getInsertOrAppendInstructionDataSerializer = getInsertOrAppendInstructionDataSerializer;
// Instruction.
function insertOrAppend(context, input) {
    // Program ID.
    ...
    // Data.
    const data = getInsertOrAppendInstructionDataSerializer().serialize(resolvedArgs);
